...
<div class="wrapper">
    <div class="page-header header-filter">
        <div class="page-header-image" style="background-image: url('../assets/img/sections/photo-1.jpg');"></div>
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="floating-box bg-default">
                    ...
                    <blockquote class="blockquote text-center mt-4">
                        <p class="mb-0 text-white">Posteado 9 Marzo 2020</p>
                        <footer class="blockquote-footer text-white">Seguidor del código
                            <cite title="Source Title">Yickson Ramírez</cite>
                        </footer>
                    </blockquote>
                    <h2 class="lead text-white p-5">In rutrum efficitur nulla, at ultrices lacus tristique vel. Sed feugiat nisl quis ligula interdum, sit amet condimentum magna lobortis. Fusce elit ipsum, luctus ac mattis at, blandit sed mauris. Pellentesque laoreet convallis dolor, quis rhoncus est scelerisque id. Vestibulum sed metus malesuada, eleifend arcu pulvinar, convallis arcu. Suspendisse sagittis lacus sed porta cursus. Suspendisse vestibulum posuere urna ut elementum. Ut mollis convallis arcu, et malesuada enim euismod et. Nullam sit amet egestas quam.</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 ml-auto mr-auto">
                    <h6 class="category">Marzo 1, 2019</h6>
